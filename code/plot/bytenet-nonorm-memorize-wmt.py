...
nonorm_model = model_dataframe(
    'hpc_asset/bytenet_nonorm_wmt_2014_timeing/bytenet_wmt_2014_gpu4_timeing',
    alpha=0.1
)
...
data = pd.concat(
  [nonorm_model, normal_model],
  keys=['non-normalized ByteNet', 'ByteNet'],
  names=['type']
)
...
gg.run(data, 'bytenet-nonorm/validation-memorize-wmt')
