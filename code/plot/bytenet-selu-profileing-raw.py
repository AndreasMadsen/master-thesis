...
trace_gpu4 = Tracing(
    'hpc_asset/bytenet_selu_wmt_2014_profile'
...
gg.run(trace_gpu4.dataframe(), 'bytenet-selu/profile-raw-gpu4', file_format='png',
       height=13)

gg.run(trace_gpu4.dataframe(), 'bytenet-selu/profile-raw-gpu4', file_format='pdf',
       height=13)
