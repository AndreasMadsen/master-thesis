...
While diagrams like in figure \ref{fig:theory:ffnn:network} are usefull for feed forward neural networks, they becomes too verbose for more complex networks. Instead each layer is just represented by a single block like in figure \ref{fig:theory:ffnn:network-block}.
