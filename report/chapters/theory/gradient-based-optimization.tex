...
Note, $H_{\ell-1}$ is only valid in some cases. In other cases, the number of weights used in the activation sum may be greater or less than $H_{\ell-1}$. In general, $\mathrm{fan}_{\ell, in}$ is used instead of $H_{\ell-1}$.
